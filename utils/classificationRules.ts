    ...
    conditions: [
      ...
      },
      {
        ...
        timeCondition: {
          ...
          endHour: 18,
          endMinute: 30,
          label: '17:00-18:30（夕方時間帯）',
        },
        remarksCategory: ['点灯確認状況'],
      },
      {
        id: 'safety_facility',
        label: '保安施設設置状況',
        description: '保安施設の設置状況',
        visualCues: [
          '作業員がカラーコーン・バリケードを設置中',
          '看板・標識を設置中',
          '作業のフォーカスが保安設備',
        ],
        remarksCategory: ['保安施設設置状況'],
      },
      {
        id: 'new_worker_training',
        label: '新規入場者教育状況',
        description: '新規入場者への安全教育',
        visualCues: [
          '室内/テント内で作業員が座って説明を聞いている',
          'プレゼン画面や教材が見える',
        ],
        remarksCategory: ['新規入場者教育状況'],
      },
      {
        id: 'safety_patrol',
        label: '安全巡視状況',
...
export const TIME_BASED_RULES: TimeBasedRule[] = [
  ...
  },
  {
    ...
    additionalConditions: ['保安灯が点灯'],
    resultCategory: 'safety_management',
    resultRemarks: '点灯確認状況',
    certainty: 'definite',
  },
];
