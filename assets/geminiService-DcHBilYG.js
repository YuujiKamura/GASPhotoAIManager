import{a1 as T,aq as k,aa as E,ar as w}from"./index-CgjG0CBN.js";import{ah as $,aA as v,az as D,aB as K,aD as z,aI as C,aJ as P,aC as G,as as J,aw as _,aj as F,aG as R,aH as j,au as b,K as q,aE as H,ax as U,av as V,L as W,aF as Y,at as Q,N as X,a7 as Z,ak as aa,ai as ea,ay as sa}from"./index-CgjG0CBN.js";import{G as x}from"./gemini-BrvM629u.js";import"./vendor-DnQy9Gg6.js";import"./fontkit-B1URexEO.js";import"./ui-ChM_gsIn.js";const B=async(e,o,y,i,n)=>{var m;const p=new x({apiKey:y}),d=T(),g=k(e.base64),c={inlineData:{mimeType:e.mimeType,data:g}},t=[];if(o.length===0)t.push({role:"user",parts:[c,{text:`この工事写真を解析してください。
ファイル名: ${e.fileName}
${e.analysis?`現在の解析結果:
