import{a0 as T,ap as E,a9 as k,aq as w}from"./index-Kzpv4UEN.js";import{ag as $,az as v,ay as D,aA as K,aC as z,aH as C,aI as P,aB as G,ar as J,av as _,ai as F,aF as R,aG as j,at as b,J as q,aD as H,aw as U,au as V,K as W,aE as Y,as as Q,M as X,a6 as Z,aj as aa,ah as ea,ax as sa}from"./index-Kzpv4UEN.js";import{G as x}from"./gemini-BrvM629u.js";import"./vendor-DnQy9Gg6.js";import"./fontkit-B1URexEO.js";import"./ui-ChM_gsIn.js";const B=async(e,o,y,i,n)=>{var m;const p=new x({apiKey:y}),d=T(),g=E(e.base64),c={inlineData:{mimeType:e.mimeType,data:g}},t=[];if(o.length===0)t.push({role:"user",parts:[c,{text:`この工事写真を解析してください。
ファイル名: ${e.fileName}
${e.analysis?`現在の解析結果:
