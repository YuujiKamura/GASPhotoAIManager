...
export type { AutoApiSettings, ModelType, ModelStatus, ModelAvailability } from './gemini';
...
import type { ModelType, AutoApiSettings } from './gemini';
