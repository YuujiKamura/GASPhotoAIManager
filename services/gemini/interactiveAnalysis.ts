...
- **備考カテゴリの選択ルール（最重要）**:
  - 黒板に書かれた文言をそのまま読み、マスタから最も近いカテゴリを選ぶ
  - 例: 黒板に「乳剤散布」→「プライムコート乳剤散布状況」
  - 例: 黒板に「端部塗布」→「端部乳剤塗布状況」
  - 黒板の文言でカテゴリを決める（散布→散布、塗布→塗布）

- **工事写真の前提知識**:
  - 乳剤散布時にベニヤ板や木製板を立てているのは「飛散防止用の養生板」
  - 板を使っていても「端部塗布」ではなく、散布範囲を制御しているだけ
  - 黒板に「散布」と書いてあれば「散布」カテゴリを選ぶ
