...
import { useManualPairing, ManualPair } from '../hooks/useManualPairing';
    ...
    <div className="fixed inset-0 z-[200] bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <h4 className="font-bold text-gray-700 mb-2 flex items-center gap-2">
                <span className="bg-orange-100 text-orange-700 px-2 py-0.5 rounded text-sm">{txt.beforeLabel}</span>
            ...
            <div>
              <h4 className="font-bold text-gray-700 mb-2 flex items-center gap-2">
                <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-sm">{txt.afterLabel}</span>
          ...
          {/* Created Pairs */}
          <div>
            <h4 className="font-bold text-gray-700 mb-2">{txt.createdPairs} ({pairs.length})</h4>
            <div className="bg-gray-50 rounded-lg p-3 max-h-40 overflow-y-auto">
              {pairs.length === 0 ? (
                ...
                <div className="space-y-2">
                  {pairs.map((pair, idx) => (
                    <div key={pair.id} className="flex items-center gap-3 bg-white p-2 rounded-lg border">
                      ...
                      <button onClick={() => handleRemovePair(pair.id)} className="ml-auto text-red-500 hover:text-red-700 p-1">
        ...
        <div className="flex gap-3 px-6 py-4 border-t bg-gray-50">
          <button onClick={onCancel} className="flex-1 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-bold">
            {txt.cancel}
          </button>
          <button
