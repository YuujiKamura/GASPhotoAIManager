...
import { ExternalLink, Key, Camera } from 'lucide-react';
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-3xl w-full max-w-md p-6 space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`${onCancel ? 'flex-1' : 'w-full'} bg-blue-500 hover:bg-blue-400 disabled:bg-slate-700 disabled:text-slate-500 text-white font-bold py-3 rounded-xl transition-all`}
          >
            設定完了
          </button>
        </div>
